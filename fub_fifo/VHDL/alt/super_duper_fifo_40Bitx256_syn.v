...
// ============================================================
// File Name: super_duper_fifo_40Bitx256.v
// Megafunction Name(s):
// 			scfifo
//
...
module  super_duper_fifo_40Bitx256_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
endmodule //super_duper_fifo_40Bitx256_altsyncram
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  super_duper_fifo_40Bitx256_cmpr
	( 
	aeb,
	dataa,
...
endmodule //super_duper_fifo_40Bitx256_cmpr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  super_duper_fifo_40Bitx256_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sset = 1'b0,
		updown_dir = 1'b1;
endmodule //super_duper_fifo_40Bitx256_cntr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  super_duper_fifo_40Bitx256_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sset = 1'b0,
		updown_dir = updown;
endmodule //super_duper_fifo_40Bitx256_cntr1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  super_duper_fifo_40Bitx256_cntr2
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sset = 1'b0,
		updown_dir = 1'b1;
endmodule //super_duper_fifo_40Bitx256_cntr2

//synthesis_resources = lut 23 M9K 2 reg 37 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  super_duper_fifo_40Bitx256_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	super_duper_fifo_40Bitx256_altsyncram   FIFOram
	( 
	...
	super_duper_fifo_40Bitx256_cmpr   almost_full_comparer
	( 
	.aeb(wire_almost_full_comparer_aeb),
	.dataa({8{1'b1}}),
	.datab(wire_usedw_counter_q));
	super_duper_fifo_40Bitx256_cmpr   two_comparison
	( 
	.aeb(wire_two_comparison_aeb),
	.dataa(wire_usedw_counter_q),
	.datab({{6{1'b0}}, 1'b1, 1'b0}));
	super_duper_fifo_40Bitx256_cntr   rd_ptr_msb
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.q(wire_rd_ptr_msb_q),
	.sclr(sclr));
	super_duper_fifo_40Bitx256_cntr1   usedw_counter
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.sclr(sclr),
	.updown(valid_wreq));
	super_duper_fifo_40Bitx256_cntr2   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
endmodule //super_duper_fifo_40Bitx256_a_dpfifo

//synthesis_resources = lut 23 M9K 2 reg 39 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  super_duper_fifo_40Bitx256_scfifo
	( 
	aclr,
	almost_empty,
	almost_full,
...
`endif
	...
	super_duper_fifo_40Bitx256_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
...
endmodule //super_duper_fifo_40Bitx256_scfifo
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module super_duper_fifo_40Bitx256 (
	aclr,
	clock,
	data,
	rdreq,
	...
	super_duper_fifo_40Bitx256_scfifo	super_duper_fifo_40Bitx256_scfifo_component (
				.rdreq (rdreq),
				.sclr (sclr),
				.aclr (aclr),
				.clock (clock),
