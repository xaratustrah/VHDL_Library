...
`endif
	...
	assign
		...
		usedw = wire_dpfifo_usedw,
		wire_ae = {{7{1'b1}}, 1'b0},
		wire_af = {{5{1'b0}}, 1'b1, 1'b0, 1'b1},
		wire_pre_ae = {8{1'b1}},
		wire_pre_af = {{5{1'b0}}, {2{1'b1}}, 1'b0};
